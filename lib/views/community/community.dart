...
//                           eventImage = '',
//                           tagString = '';
//                       eventUserId = dataController.filteredEvents.value[i].uid!;
//                       DocumentSnapshot doc = dataController.listOfUser
...
//                       try {
//                         location =
//                             dataController.filteredEvents.value[i].location!;
//                       } catch (e) {
//                         location = '';
//                       }
//
//                       try {
//                         List media =
//                             dataController.filteredEvents.value[i].media;
//
...
//
//                       try {
//                         tags = dataController.filteredEvents.value[i].tags;
//                       } catch (e) {
//                         tags = [];
//                       }
//
//                       if (tags.isEmpty) {
//                         tagString =
//                             dataController.filteredEvents[i].description!;
//                       } else {
...
//                       try {
//                         eventName =
//                             dataController.filteredEvents.value[i].eventName;
//                       } catch (e) {
//                         eventName = '';
//                       }
//
