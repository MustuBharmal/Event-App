...
class _CreateEventViewState extends State<CreateEventView> {
  ...
  List<String> listItem = ['All','Faculty', 'Student'];
  ...
  void initState() {
    ...
    // eventDate.text = '${date!.day}-${date!.month}-${date!.year}';
  }
